def get_monkey_decisions(path_to_file):
    # returns list of elements of the form [starting terms, operation, division test, what if true, what if false]
    ...
    for monkey in monkeys:
        ...
        decisions[-1].append(int(monkey[3].strip("Test: divisible by")))
...
if __name__ == "__main__":
    monkeys = get_monkey_decisions("day11input.txt")
